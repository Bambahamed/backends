export const roomActions = {
  ...
  SET_MIC_STATUS: "ROOM.SET_MIC_STATUS",
};
...
export const setMicStatus = (userId, isMuted) => {
  console.log(`Setting mic status for user ${userId} to ${isMuted}`);
  return {
    type: roomActions.SET_MIC_STATUS,
    micStatuses: {
      userId,
      isMuted,
    },
